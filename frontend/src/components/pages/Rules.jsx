...
const SectionTitle = ({ children, number, icon, subtitle }) => (
	<div className="pt-16 pb-8 animate-slide-in-left">
		<div className="flex items-end gap-4 mb-3">
			<div className="font-caprasimo text-4xl sm:text-6xl text-primary leading-none">
				№{number}
			</div>
		...
		<div className="flex items-baseline gap-3">
			<h2 className="font-caprasimo text-3xl sm:text-5xl tracking-wide text-primary">
				{children}
			</h2>
			{subtitle && (
...
const RulesTab = () => (
	<div>
		...
		<p className="mt-4 text-primary-light leading-relaxed max-w-3xl">
...
const CardsTab = () => (
	<div className="pt-8 text-primary-light italic">À venir…</div>
